...
$result = mysqli_query($conn, "SELECT * FROM product WHERE jenis = 'cHealth'");
...
if (isset($_POST["tambah"])) {
     ...
     if ($result) {
          echo "
            ...
            document.location.href = 'chome.php'
            </script>";
     } else {
          echo "
            <script>
                              ...
                              <?php if (isset($_SESSION) && isset($_SESSION["login"])) { ?>
                                   <?php if ($_SESSION['type'] == '0') { ?>
                                        <form action="" method="post">
                                             ...
                                             <button type="submit" name="tambah"><img class="shoppingcart" src="Aset/shopping_cart_FILL0_wght400_GRAD0_opsz24.svg" alt=""></button>
                                        </form>
                                   <?php } ?>
                              <?php } else { ?>
